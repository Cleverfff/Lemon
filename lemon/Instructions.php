 ...
 * Author: Pan Zitao
 * Date: 2025-07-21
 * Description: Displays the step-by-step instructions for making lemonade.
 */
...
$page_keys = ['nav', 'footer', 'common', 'instructions']; 
...
<head>
    ...
    <title><?php echo htmlspecialchars($texts['instructions_page_title'] ?? 'Instructions'); ?></title>
    <link rel="stylesheet" type="text/css" href="index.css">
    <link rel="stylesheet" type="text/css" href="Instructions.css">
</head>
<body>
    <header class="header">
        <h1 class="header-title"><?php echo htmlspecialchars($texts['instructions_header_title'] ?? 'How To Make Lemonade'); ?></h1>
    </header>
    ...
    <div class="main-wrapper">
        ...
        <main class="container">
            ...
            <h2><?php echo htmlspecialchars($texts['instructions_main_title']); ?></h2>
            <p><?php echo htmlspecialchars($texts['instructions_main_intro']); ?></p>
            
            <div class="instruction-steps">
                <div class="step-item">
                    <h3><?php echo htmlspecialchars($texts['step1_title']); ?></h3>
                    <p><?php echo htmlspecialchars($texts['step1_desc']); ?></p>
                </div>
                <div class="step-item">
                    <h3><?php echo htmlspecialchars($texts['step2_title']); ?></h3>
                    <p><?php echo htmlspecialchars($texts['step2_desc']); ?></p>
                </div>
                <div class="step-item">
                    <h3><?php echo htmlspecialchars($texts['step3_title']); ?></h3>
                    <p><?php echo htmlspecialchars($texts['step3_desc']); ?></p>
                </div>
                 <div class="step-item">
                    <h3><?php echo htmlspecialchars($texts['step4_title']); ?></h3>
                    <p><?php echo htmlspecialchars($texts['step4_desc']); ?></p>
                </div>
                <div class="step-item">
                    <h3><?php echo htmlspecialchars($texts['step5_title']); ?></h3>
                    <p><?php echo htmlspecialchars($texts['step5_desc']); ?></p>
                </div>
                <div class="step-item">
                    <h3><?php echo htmlspecialchars($texts['step6_title']); ?></h3>
                    <p><?php echo htmlspecialchars($texts['step6_desc']); ?></p>
                </div>
                <div class="step-item">
                    <h3><?php echo htmlspecialchars($texts['step7_title']); ?></h3>
                    <p><?php echo htmlspecialchars($texts['step7_desc']); ?></p>
                </div>
            </div>
        </main>
